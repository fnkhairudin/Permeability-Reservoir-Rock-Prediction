...
model = pickle.load(open(r'C:/Users/ASUS/Desktop/DataSciencePurwadhika/selfTrial/OilandGas/model/permeability_prediction.sav', 'rb'))
...
image = Image.open(r'C:/Users/ASUS/Desktop/DataSciencePurwadhika/selfTrial/OilandGas/reports/rig.jpg')
st.image(image, '')
